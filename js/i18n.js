...
const translations = {
    ...
    en: {
        ...
        about_p2: "When I'm not coding, I enjoy [add your hobby here].",
        ...
        project1_title: 'Project Name',
        project1_desc:  'Brief description of the project. What problem it solves and what you learned while building it.',
        project2_title: 'Project Name 2',
        project2_desc:  'Brief description of the project. What problem it solves and what you learned while building it.',
        project3_title: 'Project Name 3',
        project3_desc:  'Brief description of the project. What problem it solves and what you learned while building it.',
        ...
        contact_location_value:     'Your City, Country',
    ...
    es: {
        ...
        about_p2: 'Cuando no estoy programando, disfruto [agrega tu hobby aquí].',
        ...
        filter_mobile:  'Móvil',
        filter_backend: 'Backend',
        project1_title: 'Nombre del Proyecto',
        project1_desc:  'Descripción breve del proyecto. Qué problema resuelve y qué aprendiste desarrollándolo.',
        project2_title: 'Nombre del Proyecto 2',
        project2_desc:  'Descripción breve del proyecto. Qué problema resuelve y qué aprendiste desarrollándolo.',
        project3_title: 'Nombre del Proyecto 3',
        project3_desc:  'Descripción breve del proyecto. Qué problema resuelve y qué aprendiste desarrollándolo.',

        contact_title:    '¿Hablamos?',
        contact_subtitle: 'Estoy disponible para proyectos y oportunidades',
        contact_email_label:        'Email',
        contact_location_label:     'Ubicación',
        contact_location_value:     'Tu Ciudad, País',
    ...
    fr: {
        ...
        about_p2: "Quand je ne code pas, j'aime [ajoutez votre hobby ici].",
        ...
        filter_mobile:  'Mobile',
        filter_backend: 'Backend',
        project1_title: 'Nom du Projet',
        project1_desc:  'Brève description du projet. Quel problème il résout et ce que vous avez appris en le développant.',
        project2_title: 'Nom du Projet 2',
        project2_desc:  'Brève description du projet. Quel problème il résout et ce que vous avez appris en le développant.',
        project3_title: 'Nom du Projet 3',
        project3_desc:  'Brève description du projet. Quel problème il résout et ce que vous avez appris en le développant.',
        ...
        contact_location_value:     'Votre Ville, Pays',
