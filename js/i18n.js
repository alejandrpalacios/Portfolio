...
const translations = {
    ...
    en: {
        ...
        // Proyectos
        projects_title_main:   'What I can',
        projects_title_accent: 'Build',
        projects_subtitle: 'Types of web experiences I can create for you',
        projects_intro: 'Each project below is a working example — a skeleton that shows the type of site I can build. I adapt 100% to your style, brand, colors and structure. Tell me what you need and I will make it happen.',
        filter_all:     'All',
        filter_web:     'Web',
    ...
    es: {
        ...
        projects_title_main:   'Lo que puedo',
        projects_title_accent: 'Crear',
        projects_subtitle: 'Tipos de experiencias web que puedo construir para ti',
        projects_intro: 'Cada proyecto es un ejemplo funcional — un esqueleto que muestra el tipo de sitio que puedo desarrollar. Me adapto al 100% a tu estilo, marca, colores y estructura. Cuéntame lo que necesitas y lo hago realidad.',
        filter_all:     'Todos',
        filter_web:     'Web',
        filter_backend: 'Backend',
        project1_title: 'Landing Page',
    ...
    fr: {
        ...
        projects_title_main:   'Ce que je peux',
        projects_title_accent: 'Créer',
        projects_subtitle: 'Types d\'expériences web que je peux créer pour vous',
        projects_intro: 'Chaque projet est un exemple fonctionnel — un squelette montrant le type de site que je peux développer. Je m\'adapte à 100% à votre style, marque, couleurs et structure. Dites-moi ce dont vous avez besoin et je le réalise.',
        filter_all:     'Tous',
        filter_web:     'Web',
        filter_backend: 'Backend',
        project1_title: 'Landing Page',
